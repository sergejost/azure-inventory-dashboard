// Name: dashboard-inventory.bicep
// Description: This Bicep template deploys an Azure dashboard. The dashboard uses Azure Resource Graph to provide a summary view of your azure resources.
// Author: Sergej Ostashchuk
// Version: 1.0

param dashboard_name string = 'dashboard-inventory'
param dashboard_title string = 'Inventory dashboard'

resource dashboard_name_resource 'Microsoft.Portal/dashboards@2020-09-01-preview' = {
  name: dashboard_name
  location: 'eastus'
  tags: {
    'hidden-title': dashboard_title
  }
  properties: {
    lenses: [
      {
